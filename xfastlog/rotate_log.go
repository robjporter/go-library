...
import (
	"fmt"
	"github.com/robjporter/go-library/xaurora"
	"io"
	"os"
	"os/signal"
	"path/filepath"
...
var (
	info    = fmt.Sprint(xaurora.Bold(xaurora.Green("[info] ")))
	notice  = fmt.Sprint(xaurora.Bold(xaurora.Blue("[notice] ")))
	warning = fmt.Sprint(xaurora.Bold(xaurora.Red("[warning] ")))
	fatal   = fmt.Sprint(xaurora.Bold(xaurora.Magenta("[fatal] ")))
	errFlag = fmt.Sprint(xaurora.Bold(xaurora.Magenta("[error] ")))
	debug   = fmt.Sprint(xaurora.Bold(xaurora.Cyan("[debug] ")))
)
